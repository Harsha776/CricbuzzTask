...
class PopularSneakerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        fragmentPopularSneakerBinding= FragmentPopularSneakerBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sneakerAdapter = SneakerAdapter{id->
            ...
            transaction.add(R.id.fragment_section, SneakerDetailsPageFragment(),"fragment1")
        ...
        mainViewModel.getSneakerData().observe(requireActivity(), Observer {
            sneakerAdapter.setData(it as ArrayList<Sneaker>)
        })

        mainViewModel.getSearchSneakerData().observe(requireActivity(), Observer {
            sneakerAdapter.setData(it as ArrayList<Sneaker>)
        })
        ...
        fragmentPopularSneakerBinding.ivSearch.setOnClickListener {
            ...
            dialog.setContentView(com.example.cricbuzztask.R.layout.dialog_search)
            ...
            val editText:EditText = dialog.findViewById(com.example.cricbuzztask.R.id.edit_text)
